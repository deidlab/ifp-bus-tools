<template>
  <div>
    ...
    >
      <a
        href="javascript:;"
        class="bg-primary rounded-l-lg absolute ltr:-left-12 top-0 bottom-0 my-auto w-12 h-60 flex justify-center items-center text-white cursor-pointer"
        @click="showCustomizer = !showCustomizer"
      >
        <span class="-rotate-90 text-lg">Serial Settings</span>
      </a>
      <perfect-scrollbar
        :options="{
          swipeEasing: true,
